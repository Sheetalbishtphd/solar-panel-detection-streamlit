...
def add_ui_elements(image, detection_count, timestamp=None):
    ...
    counter_text = f"{detection_count} objects detected"
...
if mode == "Upload Image":
    ...
    if uploaded_file:
        ...
        with col2:
            ...
            if detection_count > 0:
                st.markdown(f'<div class="detection-counter">✅ {detection_count} solar panels detected</div>', unsafe_allow_html=True)
            else:
    ...
    if detect_button:
        if lat and lon:
            ...
            st.warning("⚠️ Please enter latitude and longitude.")
